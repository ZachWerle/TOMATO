...
```json
{
  ...
  "rule": {
    ...
    "mail": true,
    "level": 15,
    "description": "User: WORKGROUP\\*****@gmail.com logged using Remote Desktop Connection (RDP) from loopback address, possible exploit over reverse tunneling using stolen credentials.",
    "groups": [
      "win_evt_channel"
    ],
    "mitre": {
